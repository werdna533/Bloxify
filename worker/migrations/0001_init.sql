-- Ported verbatim from app/lib/db.ts SCHEMA. D1 is SQLite, so the DDL carries over
-- unchanged; keeping it identical means the same queries run against both backends.
